...
public:
    ...
    void program30_tshirt_quiz() {
        ...
        if (printChoice == "with") {
            ...
            cin >> choice;
            switch(choice) {
                case 1: design = "an eagle print"; break;
                case 2: design = "a dragon print"; break;
                case 3: design = "a geometric pattern"; break;
                case 4: design = "an abstract art print"; break;
                default: design = "a custom print"; break;
            }
        } else {
            design = "no print";
        }
        ...
        switch(choice) {
            ...
            default: size = "M"; break; // Default fallback
        }
        ...
        cin >> choice;
        switch(choice) {
            case 1: fit = "slim fit"; break;
            case 2: fit = "regular fit"; break;
            case 3: fit = "relaxed fit"; break;
            case 4: fit = "oversized"; break;
            default: fit = "regular fit"; break;
        }
    ...
    void program34_array_operations() {
        ...
        cout << "Addition:       ";
        for (int i = 0; i < 5; i++) cout << setw(6) << Add[i];
        cout << "\nSubtraction:    ";
        for (int i = 0; i < 5; i++) cout << setw(6) << Sub[i];
        cout << "\nMultiplication: ";
        for (int i = 0; i < 5; i++) cout << setw(6) << Mult[i];
        cout << "\nDivision:       ";
        for (int i = 0; i < 5; i++) {
            if (B[i] != 0) cout << setw(6) << fixed << setprecision(2) << Div[i];
            else cout << setw(6) << "undef"; // Undefined for division by zero
        }
        cout << "\n========================================\n";
    ...
    void program37_matrix_operations() {
        ...
        for (int i = 0; i < 2; i++) {
            cout << "| ";
            for (int j = 0; j < 2; j++) cout << setw(4) << Add[i][j] << " ";
            cout << "|\n";
        }
        ...
        for (int i = 0; i < 2; i++) {
            cout << "| ";
            for (int j = 0; j < 2; j++) cout << setw(4) << Sub[i][j] << " ";
            cout << "|\n";
        }
        ...
        for (int i = 0; i < 2; i++) {
            cout << "| ";
            for (int j = 0; j < 2; j++) cout << setw(4) << Mult[i][j] << " ";
            cout << "|\n";
        }
        cout << "========================================\n";
    ...
    do {
        ...
        switch(choice) {
            ...
            case 1: case 2: case 3: case 4:
                sylva.exercise1_basic_operations(); break;
            case 5: 
                sylva.exercise5_average(); break;
            case 6: 
                sylva.exercise6_odd_even(); break;
            case 7: 
                sylva.exercise7_pos_neg_zero(); break;
            case 8: 
                sylva.exercise8_sqrt(); break;
            case 9: 
                sylva.exercise9_absolute_value(); break;
            case 10: 
                sylva.exercise10_perimeter_area(); break;
            case 11: case 12: case 13:
                sylva.exercise11_multiplication_table(); break;
            case 14: 
                sylva.exercise14_hypotenuse(); break;
            case 15: case 16:
                sylva.exercise15_currency_exchange(); break;
            case 17: 
                sylva.exercise17_exchange_numbers(); break;
            case 18: 
                sylva.exercise18_smallest_of_three(); break;
            case 19: 
                sylva.exercise19_largest_of_three(); break;
            case 20: 
                sylva.exercise20_sum_of_squares(); break;
            case 21: 
                sylva.program21_largest_smallest(); break;
            case 22: 
                sylva.program22_sum_100(); break;
            case 23: 
                sylva.program23_sum_100_even(); break;
            case 24: 
                sylva.program24_linear_equation(); break;
            case 25: 
                sylva.program25_quadratic_equation(); break;
            case 26: 
                sylva.program26_sum_n(); break;
            case 27: 
                sylva.program27_sum_n_even(); break;
            case 28: 
                sylva.program28_unit_converter(); break;
            case 29: 
                sylva.program29_quiz(); break;
            case 30: 
                sylva.program30_tshirt_quiz(); break;
            case 31: 
                sylva.program31_array_sum(); break;
            case 32: 
                sylva.program32_dual_array_add(); break;
            case 33: 
                sylva.program33_array_mult_div(); break;
            case 34: 
                sylva.program34_array_operations(); break;
            case 35: 
                sylva.program35_scalar_mult(); break;
            case 36: 
                sylva.program36_matrix_sum(); break;
            case 37: 
                sylva.program37_matrix_operations(); break;
            case 38: 
                sylva.program38_greater_function(); break;
            case 39: 
                sylva.program39_sum_function(); break;
            case 40: 
                sylva.program40_difference_function(); break;
            case 0:
